...
public class TaskAddAllProcessor implements Processor<TaskAddAllRequest, TaskAddResult> {
    ...
    @Override
    public void process(TaskAddAllRequest addAllRequest, TaskAddResult taskAddResult, Object... others) throws Exception {
        ...
        if (sourceNamingService == null) {
            throw new SkyWalkerException("仅支持 Nacos 为源的同步类型");
        }
        ...
        if (catalogServiceResult == null || catalogServiceResult.getCount() <= 0) {
            throw new SkyWalkerException("sourceCluster 数据为空");
        }
    ...
    static class EnhanceNamingService {
        ...
        public CatalogServiceResult catalogServices(@Nullable String serviceName, @Nullable String group) throws NacosException {
            ...
            while (tmpResult != null && tmpResult.serviceList.size() >= pageSize) {
                pageNo++;
        ...
        public CatalogServiceResult catalogServices(@Nullable String serviceName, @Nullable String group,
            ...
            params.put("groupNameParam", group);
            params.put("pageNo", String.valueOf(pageNo));
            params.put("pageSize", String.valueOf(pageSize));

            final String result = this.serverProxy.reqApi(UtilAndComs.nacosUrlBase + "/catalog/services", params, HttpMethod.GET);
